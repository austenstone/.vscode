...
tools: ['execute/testFailure', 'read/readFile', 'search', 'web', 'firecrawl-mcp/*', 'io.github.upstash/context7/*', 'agent', 'github-read-only/*', 'ms-vscode.vscode-websearchforcopilot/websearch']
handoffs:
